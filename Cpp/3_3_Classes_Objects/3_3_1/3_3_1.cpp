...
// Конструктор класса не пишем - компилятор сам сгенерирует конструктор по умолчанию (пустой без параметров)
...
public:
	...
	{
		if (num1 != 0) {							// если значение аргумента не равно 0
			this->num1 = num1;						// устанавливаем значение поля num1 равное значению аргумента num1
	...
	{
		if (num2 != 0) {							// если значение аргумента не равно 0
			this->num2 = num2;						// устанавливаем значение поля num2 равное значению аргумента num2
			return true;							// и возвращаем true
		}
		return false;								// в противном случае возвращаем false
	}	
...
int main(int argc, char** argv)
{
	...
	Calculator calculator;							// Создаем calculator - экземпляр класса Calculator

	while (true) {									// Бесконечный цикл

		std::cout << "Введите num1: ";				// Запрашиваем num1
		std::cin >> input_num1;

		while (!calculator.set_num1(input_num1)) {	// Запрашиваем num1 до тех пор, пока не будет введено число отличное от 0
			std::cout << "Неверный ввод!\nВведите num1 :";
			std::cin >> input_num1;
		}
		
		std::cout << "Введите num2: ";				// Запрашиваем num2
		std::cin >> input_num2;

		while (!calculator.set_num2(input_num2)) {	// Запрашиваем num2 до тех пор, пока не будет введено число отличное от 0
			std::cout << "Неверный ввод!\nВведите num2 :";
			std::cin >> input_num2;
		}
		...
		std::cout << "num2 * num1 = " << calculator.multiply() << std::endl;
